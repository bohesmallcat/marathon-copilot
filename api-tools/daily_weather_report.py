...
Fetches weather for race cities, evaluates impact on runners,
...
RACES = [
    {
        "name": "XX城市半程马拉松",
        "name_en": "Example City Half Marathon",
        "date": datetime.date(2026, 4, 1),
        "start_time": "07:00",
        "city": "Shanghai",
        "city_cn": "XX城市",
        "distance": "半马 21.1km",
        "course_notes": "城区平坦赛道，部分滨江开阔段有侧风",
        "runners": [
            {
                "name": "Runner_A",
                "goal": "sub-1:20",
    ...
    {
        "name": "YY城市马拉松",
        "name_en": "Example City Marathon",
        "date": datetime.date(2026, 4, 15),
        "start_time": "07:30",
        "city": "Shanghai",
        "city_cn": "YY城市",
        "distance": "全马 42.195km",
        "course_notes": "湖滨平坦赛道，全程累计爬升极低，适合PB",
        "runners": [
            {
                "name": "Runner_A",
                "goal": "sub-2:40",
...
def generate_report(today):
    ...
    for race in RACES:
        ...
        if city not in cities:
            cities[city] = fetch_weather(city)
